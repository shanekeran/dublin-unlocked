...
//-------------- Day / Night mode toggle ------------------ \\
    ...
    $("#time-button").on("click", function(){
        ...
        $(".back-to-top").children().toggleClass("white-font");
    ...
    request.onload = function () {
        ...
        if (request.status >= 200 && request.status < 400) {
            ...
            for (let i = 0; i < 5;i++) {
                ...
                const conditionsElement = $(".conditions")[i];
                ...
                switch(forecast.conditions){
                    ...
                    case "Partially cloudy":
                        $(iconElement).attr("src","assets/images/weather/cloudy-sun.png");
                        break;
                    case "Sunny":
            ...
            for (let i = 0; i < 5;i++) {
                const errorMessage = $(".conditions")[i];
                const forecastShow= $(".daily-forecast")[3];
                // Display error message
                $(errorMessage).html("Weather Forecast Unavailable. Please try again later.");
                // Hide forecasts
                $(".daily-forecast").hide();
    ...
    eventRequest.open("GET","https://app.ticketmaster.com/discovery/v2/events.json?countryCode=IE&apikey=DUV4bAYj0383DtTig69KAtWGmipVv1rt&geoPoint=gc7x&radius=20&sort=random" , true);
